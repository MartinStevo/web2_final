                ...
                <div class="wrapper fadeInDown">
                    <div id="formContent">
                        ...
                        <form id="classical_form" action="index.php" method="post">
                            ...
                            <input type="text" id="login" name="login" class="fadeIn first lang-placeholder" placeholder="login" key="login-holder">
                            <input type="password" id="password" name="password" class="fadeIn second lang-placeholder" key="passwd-holder" placeholder="password">
                            <input type="text" id="2fa" name="2fa" placeholder="Google Authenticator Code" class="fadeIn third lang-placeholder" key="code-holder">
                            <input type="submit" class="fadeIn fourth lang-value" key="sub-login" value="Log In">
                        ...
                        <form id="ldap_form" action="index.php" method="post">
                            ...
                            <input type="text" id="login" name="login" placeholder="login" class="fadeIn first lang-placeholder" key="login-holder">
                            <input type="password" id="password" name="password" placeholder="password" class="fadeIn second lang-placeholder" key="passwd-holder">
                            <input type="submit" class="fadeIn third lang-value" key="sub-login" value="Log In">
